...
graph['0'].add_neighbors([graph['1'], graph['2']], [1, 1]) # 2, 6
graph['3'].add_neighbors([graph['1'], graph['2'], graph['4'], graph['5']], [1, 1, 1, 1]) # 5, 8, 10, 15
graph['5'].add_neighbors([graph['4'], graph['6']], [1, 1]) # 6, 6
graph['4'].add_neighbor(graph['6'], 1) # 2
