...
starting_heading = '+y-facing' #Either: '-x-facing', which would be facing left with a top down perspective for example, '+x-facing', '-y-facing', '+y-facing'

paths = {
    #1 : {"Source Node":(0, 0),"Destination Node":(0, 3),"Obscured Nodes":[(0,2),(1,2),(2,2), (0,0),(0,1),(0,2)]}
...
starting_headings = { # The unit vectors for the start states. This does not change
    '+y-facing' : (0, 1),
    '-y-facing' : (0, -1),
    '-x-facing' : (-1, 0),
    'x-facing' : (1, 0)
...
statemachine # start the program by running the statemachine 